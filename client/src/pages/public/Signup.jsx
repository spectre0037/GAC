    ...
    <div className="min-h-screen bg-[#EBF2F2] px-3 py-3 sm:px-5 sm:py-5 md:px-6 md:py-6 lg:px-8 lg:py-8">
      ...
      >
        {/* =========================================================
            LEFT VISUAL PANEL
        ========================================================= */}
        <div className="relative hidden overflow-hidden bg-[#1A2B48] lg:flex lg:w-[45%] xl:w-[46%]">
          {/* Decorative rings */}
          ...
          {/* Sun */}
          <div className="absolute right-10 top-16 h-20 w-20 rounded-full bg-[#EBF2F2]/90 xl:right-14 xl:top-20 xl:h-24 xl:w-24" />

          {/* Content */}
          <div className="relative z-10 flex h-full w-full flex-col justify-between p-8 xl:p-10 2xl:p-14">
            {/* Logo */}
            ...
            {/* Main Message */}
            <div className="relative max-w-lg pb-10 xl:pb-12">
        ...
        >
          <div className="mx-auto w-full max-w-xl">
            ...
            <Link
              to="/"
              className="mb-8 flex items-center gap-3 sm:mb-10 lg:hidden"
            >
            ...
            <div className="mb-7 sm:mb-8">
              ...
              <p className="mt-4 text-sm leading-6 text-[#688BB0] sm:leading-7">
            ...
            <form
              ...
              className="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-x-4 sm:gap-y-5"
            >
              {/* Full Name */}
              ...
              <div className="flex min-w-0 flex-col gap-2">
                <Label
                  htmlFor="regNo"
                  className="text-[10px] font-semibold uppercase tracking-[0.12em] text-[#1A2B48] sm:text-xs"
                >
                  Registration No.
              ...
              {/* Error */}
              {formError && (
                <div className="min-w-0 rounded-xl border border-red-200 bg-red-50 px-4 py-3 sm:col-span-2 sm:rounded-2xl">
              ...
              {/* Submit */}
              <div className="pt-0.5 sm:col-span-2 sm:pt-1">
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="
              ...
              {/* Login divider */}
              <div className="relative flex items-center gap-3 pt-1 sm:col-span-2 sm:gap-4 sm:pt-2">
